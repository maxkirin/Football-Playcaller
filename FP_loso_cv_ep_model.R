...
pbp_ep_model_data <- read.csv("data/FP_pbp_ep_model_data_4_szn.csv") %>%
...
write_csv(ep_model_loso_preds, "data/FP_ep_model_loso_preds_4_szn.csv")
...
ggsave("data/loso_cv.png",width = 9, height = 5, units = "in")
